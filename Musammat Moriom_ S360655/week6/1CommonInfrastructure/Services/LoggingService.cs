...
namespace _1CommonInfrastructure.Services
{
    public class LoggingService : ILoggingService
    {
        ...
        {
            var connectionString = "server=DESKTOP-A96S363;initial catalog=PRT585_Group_7;integrated security=True;MultipleActiveResultSets=True;TrustServerCertificate=True;";//_configuration.GetSection("ConnectionStrings:ApplicationDB");                    
