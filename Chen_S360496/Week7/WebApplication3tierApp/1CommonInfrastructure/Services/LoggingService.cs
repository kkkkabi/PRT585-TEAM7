...
namespace _1CommonInfrastructure.Services
{
    public class LoggingService : ILoggingService
    {
        ...
        {
            var connectionString = "Server=.\\SQLEXPRESS;Database=PRT585_Chen;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True;";//_configuration.GetSection("ConnectionStrings:ApplicationDB");                    
